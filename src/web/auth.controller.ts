...
import { WebRegisterDto } from '@/web/dto/auth.dto';
import { Body, Controller, Post } from '@nestjs/common';
import { ApiBody, ApiOkResponse, ApiOperation, ApiTags } from '@nestjs/swagger';
import { WebAuthSessionResponseDto, WebLoginDto } from './dto/auth.dto';
...
export class WebAuthController {
  ...
  @ApiOkResponse({ type: WebLoginDto, description: '登录成功' })
